![shieldsIO](https://img.shields.io/github/issues/Fictizia/Master-en-programacion-fullstack-con-JavaScript-y-Node.js_ed4.svg)
...
- [Código base (Codebase)](https://12factor.net/es/codebase)
- [Dependencias](https://12factor.net/es/dependencies)
- [Configuraciones](https://12factor.net/es/config)
- [Backing services](https://12factor.net/es/backing-services)
- [Construir, desplegar, ejecutar](https://12factor.net/es/build-release-run)
- [Procesos](https://12factor.net/es/processes)
- [Asignación de puertos](https://12factor.net/es/port-binding) 
- [Concurrencia](https://12factor.net/es/concurrency)
- [Desechabilidad](https://12factor.net/es/disposability)
- [Paridad en desarrollo y producción](https://12factor.net/es/dev-prod-parity)
- [Historiales](https://12factor.net/es/logs)
- [Administración de procesos](https://12factor.net/es/admin-processes)
