...
### PUG: Sintaxis
- [Lo básico](http://naltatis.github.io/jade-syntax-docs/#basics)
- [Comentarios](http://naltatis.github.io/jade-syntax-docs/#comments)
- [Id y Class](http://naltatis.github.io/jade-syntax-docs/#basics)
- [Anidación](http://naltatis.github.io/jade-syntax-docs/#nesting)
- [Textos](http://naltatis.github.io/jade-syntax-docs/#text)
- [Texto con variables]( http://naltatis.github.io/jade-syntax-docs/#text)
- [Variables (desde la plantilla)](http://naltatis.github.io/jade-syntax-docs/#variables)
- [Escapado](http://naltatis.github.io/jade-syntax-docs/#escaping)
- [Atributos](http://naltatis.github.io/jade-syntax-docs/#attributes)
- [Condicionales: if, else, else if y unless](http://naltatis.github.io/jade-syntax-docs/#if)
- [Case](http://naltatis.github.io/jade-syntax-docs/#case)
- [for y each](http://naltatis.github.io/jade-syntax-docs/#for)
- [Mixin](http://naltatis.github.io/jade-syntax-docs/#mixin)
- [Código](https://pugjs.org/language/code.html)
