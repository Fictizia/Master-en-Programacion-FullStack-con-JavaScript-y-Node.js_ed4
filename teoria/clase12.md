...
```javascript
	//Solución aquí. Pista: buscar por la clase .plan en la web
```
...
```javascript
		...
		// Solución aquí. Pista: buscar las imagenes por el selector ".td-module-thumb img"

		
		// Bucle para recorrer las imagenes
			// url
			...
			// Crear string con la URL a placekitten.com con 
			var sustituto = "https://placekitten.com/"+ancho+"/"+alto;
			// Añadir al elemento adecuado la nueva URL
...
```javascript
	// Guardar aquí los datos de cada profesor
	var listaProfesores = [];
	
	// Pista: los profesores están guardados en la clase .microCard

	// Bucle para recorrer cada profesor
		// Generar un JSON con los datos de cada profesor
				
		// Acceder a los links de cada profesor usando el selector .microBtns > li

		// Iterar sobre los links de cada profesor
		// Añadir cada link como un nuevo elemento al JSON

		// Guardar en el array los datos de cada profesor
	}
	// Sacar por pantalla los datos de cada profesor
```