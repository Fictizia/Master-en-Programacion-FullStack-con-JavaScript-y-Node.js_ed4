...
**Recursos**
- [Nodejs Docs | readline](https://nodejs.org/api/readline.html)



### Vorpal

![img](../assets/clase85/4f2e5362-c1a6-40e0-823d-76822dc5db01.jpeg)
...
**1 -** Vamos a crear una CLI con Vorpal para saber que terremotos pasaron en el mundo. 
Para ello preguntaremos al usuario el periodo (hora, dia, semana, mes) y la intensidad (significativos, todos, +1.1...). 
Usaremos como fuente de datos [USGV](http://earthquake.usgs.gov/earthquakes/feed/v1.0/geojson.php)
