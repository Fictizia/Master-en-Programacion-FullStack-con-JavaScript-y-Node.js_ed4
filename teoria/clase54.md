...
- [Task automation with npm run](https://github.com/FrontenderMagazine/task_automation_with_npm_run/blob/master/eng.md)
...
- [Reemplazar grunt/gulp con un script de NPM](https://thecocktail.engineering/reemplazar-grunt-gulp-con-un-script-de-npm-919f0e62d5bd)
- [Why npm Scripts?](https://css-tricks.com/why-npm-scripts/)
- [Write Simple Tasks for Development — The Power of NPM Scripts](https://itnext.io/the-power-of-npm-scripts-57aaad9f038d)
...
- Recuerda que existen multiples operadores en Linux y OSX:
  - Puedes usar paralelismo dentro del mismo comando utilizando el operador `&` y no unicamente `&&`, ejemplo: `npm run watch-js & npm run watch-css`
