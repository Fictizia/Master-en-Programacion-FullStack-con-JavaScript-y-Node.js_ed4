...
*/
(function datosMetereologia(url){
...
/** 
 * @description var camaras is an array with the ids of the traffic cameras of madrid that we use to complete the url of the following fetch
*/
